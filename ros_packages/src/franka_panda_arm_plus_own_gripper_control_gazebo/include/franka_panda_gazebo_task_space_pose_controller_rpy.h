...
namespace franka_panda_gazebo_controller
{
	...
	VectorXd joint_velocity_desired(7), joint_acceleration_desired(7), joint_torque_command(7);
	...
	VectorXd pose_rpy_bE(6), pose_rpy_bE_desired(6), pose_rpy_bE_init(6), pose_rpy_bE_traj(6), pose_error(6);
	VectorXd velocity_bE(6), velocity_bE_desired(6), velocity_bE_traj(6), velocity_error(6);
	VectorXd acceleration_bE_desired(6), acceleration_bE_traj(6);
	...
	ofstream task_space_pose_command_log;
	ofstream task_space_pose_response_log;
	ofstream task_space_pose_error_log;
	
	ofstream task_space_velocity_command_log;
	ofstream task_space_velocity_response_log;
	ofstream task_space_velocity_error_log;
	
	ofstream task_space_acceleration_command_log;
	ofstream task_space_acceleration_response_log;
	ofstream task_space_acceleration_error_log;
