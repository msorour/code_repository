namespace franka_panda_gazebo_controller
{
	...
	Eigen::VectorXd joint_position_init(7), joint_position_traj(7), joint_position_error(7),  joint_acceleration_traj(7);
	Eigen::VectorXd joint_velocity_init(7), joint_velocity_traj(7), joint_velocity_error(7);
	...
	Eigen::VectorXd pose_rpy_bE(6), pose_rpy_bE_desired(6), pose_rpy_bE_traj(6), pose_error(6), pose_rpy_bE_init(6);
	Eigen::VectorXd velocity_bE(6), velocity_bE_desired(6), velocity_bE_traj(6), velocity_error(6), velocity_bE_init(6);
	...
	std::ofstream task_space_velocity_desired_log;
	std::ofstream task_space_velocity_traj_log;
