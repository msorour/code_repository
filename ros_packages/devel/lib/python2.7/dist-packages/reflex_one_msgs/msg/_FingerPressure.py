...
"""autogenerated by genpy from reflex_one_msgs/FingerPressure.msg. Do not edit."""
import sys
...
class FingerPressure(genpy.Message):
  _md5sum = "fe4417140692b62d71a7ba82897b83f5"
  _type = "reflex_one_msgs/FingerPressure"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_9H().pack(*self.sensor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.sensor = _get_struct_9H().unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.sensor = numpy.frombuffer(str[start:end], dtype=numpy.uint16, count=9)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
