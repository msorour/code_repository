...
"""autogenerated by genpy from reflex_one_msgs/Hand.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['reflex_one_msgs/Finger[3]','reflex_one_msgs/Motor[5]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.finger is None:
        self.finger = [reflex_one_msgs.msg.Finger() for _ in range(3)]
      if self.motor is None:
        self.motor = [reflex_one_msgs.msg.Motor() for _ in range(5)]
    else:
      self.finger = [reflex_one_msgs.msg.Finger() for _ in range(3)]
      self.motor = [reflex_one_msgs.msg.Motor() for _ in range(5)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.finger = []
      for i in range(0, 3):
        val1 = reflex_one_msgs.msg.Finger()
        _x = val1
        start = end
        end += 8
      ...
      self.motor = []
      for i in range(0, 5):
        val1 = reflex_one_msgs.msg.Motor()
        _x = val1
        start = end
        end += 44
