...
"""autogenerated by genpy from reflex_msgs/SetTactileThresholdRequest.msg. Do not edit."""
import sys
...
class SetTactileThresholdRequest(genpy.Message):
  ...
  _type = "reflex_msgs/SetTactileThresholdRequest"
...
"""
  __slots__ = ['finger']
  _slot_types = ['reflex_msgs/FingerPressure[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.finger is None:
        self.finger = [reflex_msgs.msg.FingerPressure() for _ in range(3)]
    else:
      self.finger = [reflex_msgs.msg.FingerPressure() for _ in range(3)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.finger = []
      for i in range(0, 3):
        val1 = reflex_msgs.msg.FingerPressure()
        start = end
        end += 18
...
def _get_struct_9H():
    ...
    return _struct_9H
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from reflex_msgs/SetTactileThresholdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetTactileThresholdResponse(genpy.Message):
  ...
  _type = "reflex_msgs/SetTactileThresholdResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
"""
  __slots__ = []
...
class SetTactileThreshold(object):
  _type          = 'reflex_msgs/SetTactileThreshold'
  _md5sum = '01cec83f9d223083364c730460331524'
