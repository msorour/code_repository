...
bool operator==(const ::reflex_one_msgs::SetTactileThresholdRequest_<ContainerAllocator1> & lhs, const ::reflex_one_msgs::SetTactileThresholdRequest_<ContainerAllocator2> & rhs)
{
