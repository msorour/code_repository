...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-srv:<SetSpeed-request> is deprecated: use reflex_msgs-srv:SetSpeed-request instead.")))

(cl:ensure-generic-function 'motor-val :lambda-list '(m))
(cl:defmethod motor-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-srv:motor-val is deprecated.  Use reflex_msgs-srv:motor instead.")
  (motor m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-srv:<SetSpeed-response> is deprecated: use reflex_msgs-srv:SetSpeed-response instead.")))
