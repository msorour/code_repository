...
(cl:defmethod cl:initialize-instance :after ((m <Finger>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Finger)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-msg:<Finger> is deprecated: use reflex_msgs-msg:Finger instead.")))

(cl:ensure-generic-function 'proximal-val :lambda-list '(m))
(cl:defmethod proximal-val ((m <Finger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:proximal-val is deprecated.  Use reflex_msgs-msg:proximal instead.")
  (proximal m))

(cl:ensure-generic-function 'distal_approx-val :lambda-list '(m))
(cl:defmethod distal_approx-val ((m <Finger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:distal_approx-val is deprecated.  Use reflex_msgs-msg:distal_approx instead.")
  (distal_approx m))

(cl:ensure-generic-function 'contact-val :lambda-list '(m))
(cl:defmethod contact-val ((m <Finger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:contact-val is deprecated.  Use reflex_msgs-msg:contact instead.")
  (contact m))

(cl:ensure-generic-function 'pressure-val :lambda-list '(m))
(cl:defmethod pressure-val ((m <Finger>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:pressure-val is deprecated.  Use reflex_msgs-msg:pressure instead.")
  (pressure m))
