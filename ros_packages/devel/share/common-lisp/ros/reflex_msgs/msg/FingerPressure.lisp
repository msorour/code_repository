...
(cl:defmethod cl:initialize-instance :after ((m <FingerPressure>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FingerPressure)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-msg:<FingerPressure> is deprecated: use reflex_msgs-msg:FingerPressure instead.")))

(cl:ensure-generic-function 'sensor-val :lambda-list '(m))
(cl:defmethod sensor-val ((m <FingerPressure>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:sensor-val is deprecated.  Use reflex_msgs-msg:sensor instead.")
  (sensor m))
