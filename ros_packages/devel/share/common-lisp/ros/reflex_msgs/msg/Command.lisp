...
(cl:defclass <Command> (roslisp-msg-protocol:ros-message)
  ((pose
    :reader pose
    :initarg :pose
    :type reflex_msgs-msg:PoseCommand
    :initform (cl:make-instance 'reflex_msgs-msg:PoseCommand))
   (velocity
    :reader velocity
    :initarg :velocity
    :type reflex_msgs-msg:VelocityCommand
    :initform (cl:make-instance 'reflex_msgs-msg:VelocityCommand)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-msg:<Command> is deprecated: use reflex_msgs-msg:Command instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:pose-val is deprecated.  Use reflex_msgs-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Command>)))
  ...
  (cl:format cl:nil "PoseCommand pose~%VelocityCommand velocity~%~%================================================================================~%MSG: reflex_msgs/PoseCommand~%# Position in radians of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape~%~%================================================================================~%MSG: reflex_msgs/VelocityCommand~%# Velocity in radians/second of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Command)))
  "Returns full string definition for message of type 'Command"
  (cl:format cl:nil "PoseCommand pose~%VelocityCommand velocity~%~%================================================================================~%MSG: reflex_msgs/PoseCommand~%# Position in radians of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape~%~%================================================================================~%MSG: reflex_msgs/VelocityCommand~%# Velocity in radians/second of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape~%~%~%"))
