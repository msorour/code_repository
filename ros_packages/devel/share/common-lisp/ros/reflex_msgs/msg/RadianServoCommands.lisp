...
(cl:defmethod cl:initialize-instance :after ((m <RadianServoCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadianServoCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-msg:<RadianServoCommands> is deprecated: use reflex_msgs-msg:RadianServoCommands instead.")))

(cl:ensure-generic-function 'radian_commands-val :lambda-list '(m))
(cl:defmethod radian_commands-val ((m <RadianServoCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs-msg:radian_commands-val is deprecated.  Use reflex_msgs-msg:radian_commands instead.")
  (radian_commands m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RadianServoCommands>)))
  ...
  "reflex_msgs/RadianServoCommands")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RadianServoCommands)))
  "Returns string type for a message object of type 'RadianServoCommands"
  "reflex_msgs/RadianServoCommands")
