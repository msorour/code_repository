...
(cl:defmethod cl:initialize-instance :after ((m <PoseCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs-msg:<PoseCommand> is deprecated: use reflex_msgs-msg:PoseCommand instead.")))
