...
(cl:defmethod cl:initialize-instance :after ((m <ForceCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ForceCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs2-msg:<ForceCommand> is deprecated: use reflex_msgs2-msg:ForceCommand instead.")))
