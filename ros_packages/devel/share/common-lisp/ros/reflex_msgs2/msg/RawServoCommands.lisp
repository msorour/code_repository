...
(cl:defmethod cl:initialize-instance :after ((m <RawServoCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawServoCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs2-msg:<RawServoCommands> is deprecated: use reflex_msgs2-msg:RawServoCommands instead.")))

(cl:ensure-generic-function 'raw_positions-val :lambda-list '(m))
(cl:defmethod raw_positions-val ((m <RawServoCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:raw_positions-val is deprecated.  Use reflex_msgs2-msg:raw_positions instead.")
  (raw_positions m))
