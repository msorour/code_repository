...
(cl:defmethod cl:initialize-instance :after ((m <Motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs2-msg:<Motor> is deprecated: use reflex_msgs2-msg:Motor instead.")))

(cl:ensure-generic-function 'joint_angle-val :lambda-list '(m))
(cl:defmethod joint_angle-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:joint_angle-val is deprecated.  Use reflex_msgs2-msg:joint_angle instead.")
  (joint_angle m))

(cl:ensure-generic-function 'raw_angle-val :lambda-list '(m))
(cl:defmethod raw_angle-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:raw_angle-val is deprecated.  Use reflex_msgs2-msg:raw_angle instead.")
  (raw_angle m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:velocity-val is deprecated.  Use reflex_msgs2-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'load-val :lambda-list '(m))
(cl:defmethod load-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:load-val is deprecated.  Use reflex_msgs2-msg:load instead.")
  (load m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:voltage-val is deprecated.  Use reflex_msgs2-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:temperature-val is deprecated.  Use reflex_msgs2-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'error_state-val :lambda-list '(m))
(cl:defmethod error_state-val ((m <Motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_msgs2-msg:error_state-val is deprecated.  Use reflex_msgs2-msg:error_state instead.")
  (error_state m))
