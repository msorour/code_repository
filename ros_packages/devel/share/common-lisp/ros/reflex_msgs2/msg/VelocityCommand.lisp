...
(cl:defmethod cl:initialize-instance :after ((m <VelocityCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_msgs2-msg:<VelocityCommand> is deprecated: use reflex_msgs2-msg:VelocityCommand instead.")))
