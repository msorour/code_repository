...
(cl:defclass <Hand> (roslisp-msg-protocol:ros-message)
  ((finger
    :reader finger
    :initarg :finger
    :type (cl:vector reflex_one_msgs-msg:Finger)
   :initform (cl:make-array 3 :element-type 'reflex_one_msgs-msg:Finger :initial-element (cl:make-instance 'reflex_one_msgs-msg:Finger)))
   (motor
    :reader motor
    :initarg :motor
    :type (cl:vector reflex_one_msgs-msg:Motor)
   :initform (cl:make-array 5 :element-type 'reflex_one_msgs-msg:Motor :initial-element (cl:make-instance 'reflex_one_msgs-msg:Motor))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Hand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_one_msgs-msg:<Hand> is deprecated: use reflex_one_msgs-msg:Hand instead.")))

(cl:ensure-generic-function 'finger-val :lambda-list '(m))
(cl:defmethod finger-val ((m <Hand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_one_msgs-msg:finger-val is deprecated.  Use reflex_one_msgs-msg:finger instead.")
  (finger m))

(cl:ensure-generic-function 'motor-val :lambda-list '(m))
(cl:defmethod motor-val ((m <Hand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reflex_one_msgs-msg:motor-val is deprecated.  Use reflex_one_msgs-msg:motor instead.")
  (motor m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Hand>)))
  ...
  (cl:format cl:nil "# message for ReFlex Hand~%Finger[3] finger       # Hold out your right hand palm up, with pointer finger, middle finger and thumb extended~%                       # Pointer = finger[0], Middle = finger[1], Thumb = finger[2]~%Motor[5] motor         # Finger 1, Finger 2, Finger 3, Preshape1 and Preshape2~%~%================================================================================~%MSG: reflex_one_msgs/Finger~%# message for ReFlex Fingers~%float32 proximal		# radians, measured from all open = 0, to pi = closed~%float32 distal_approx   # radians, measured from all open = 0, to roughly pi = against proximal pad, relative to prox link~%bool[9] contact			# binary, 0 = proximal, 8 = fingertip~%float32[9] pressure		# scalar, dimensionless units, 0 = proximal, 8 = fingertip (can go negative)~%~%================================================================================~%MSG: reflex_one_msgs/Motor~%float64 joint_angle~%float64 raw_angle~%float64 velocity~%float64 load~%float64 voltage~%int32 temperature~%string error_state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Hand)))
  "Returns full string definition for message of type 'Hand"
  (cl:format cl:nil "# message for ReFlex Hand~%Finger[3] finger       # Hold out your right hand palm up, with pointer finger, middle finger and thumb extended~%                       # Pointer = finger[0], Middle = finger[1], Thumb = finger[2]~%Motor[5] motor         # Finger 1, Finger 2, Finger 3, Preshape1 and Preshape2~%~%================================================================================~%MSG: reflex_one_msgs/Finger~%# message for ReFlex Fingers~%float32 proximal		# radians, measured from all open = 0, to pi = closed~%float32 distal_approx   # radians, measured from all open = 0, to roughly pi = against proximal pad, relative to prox link~%bool[9] contact			# binary, 0 = proximal, 8 = fingertip~%float32[9] pressure		# scalar, dimensionless units, 0 = proximal, 8 = fingertip (can go negative)~%~%================================================================================~%MSG: reflex_one_msgs/Motor~%float64 joint_angle~%float64 raw_angle~%float64 velocity~%float64 load~%float64 voltage~%int32 temperature~%string error_state~%~%~%"))
