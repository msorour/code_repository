...
(cl:defmethod cl:initialize-instance :after ((m <VelocityCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_one_msgs-msg:<VelocityCommand> is deprecated: use reflex_one_msgs-msg:VelocityCommand instead.")))
...
(cl:defmethod preshape1-val ((m <VelocityCommand>))
...
(cl:defmethod preshape2-val ((m <VelocityCommand>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VelocityCommand>)))
  ...
  "reflex_one_msgs/VelocityCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VelocityCommand)))
  "Returns string type for a message object of type 'VelocityCommand"
  "reflex_one_msgs/VelocityCommand")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VelocityCommand>)))
  ...
  (cl:format cl:nil "# Velocity in radians/second of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape1~%float64 preshape2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VelocityCommand)))
  "Returns full string definition for message of type 'VelocityCommand"
  (cl:format cl:nil "# Velocity in radians/second of various motors~%float64 f1~%float64 f2~%float64 f3~%float64 preshape1~%float64 preshape2~%~%~%"))
