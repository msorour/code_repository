...
(cl:defmethod cl:initialize-instance :after ((m <ForceCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ForceCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reflex_one_msgs-msg:<ForceCommand> is deprecated: use reflex_one_msgs-msg:ForceCommand instead.")))
...
(cl:defmethod preshape1-val ((m <ForceCommand>))
...
(cl:defmethod preshape2-val ((m <ForceCommand>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ForceCommand>)))
  ...
  (cl:format cl:nil "# Torque of various motors. UNITLESS due to the way Dynamixels measure torque~%# More information on the force feedback here:~%#	http://support.robotis.com/en/product/dynamixel/mx_series/mx-28.htm#Actuator_Address_28~%float64 f1~%float64 f2~%float64 f3~%float64 preshape1~%float64 preshape2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ForceCommand)))
  "Returns full string definition for message of type 'ForceCommand"
  (cl:format cl:nil "# Torque of various motors. UNITLESS due to the way Dynamixels measure torque~%# More information on the force feedback here:~%#	http://support.robotis.com/en/product/dynamixel/mx_series/mx-28.htm#Actuator_Address_28~%float64 f1~%float64 f2~%float64 f3~%float64 preshape1~%float64 preshape2~%~%~%"))
