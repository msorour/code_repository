...
class ForceCommand {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('preshape1')) {
        this.preshape1 = initObj.preshape1
      }
      else {
        this.preshape1 = 0.0;
      }
      if (initObj.hasOwnProperty('preshape2')) {
        this.preshape2 = initObj.preshape2
      }
      else {
        this.preshape2 = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [preshape1]
    bufferOffset = _serializer.float64(obj.preshape1, buffer, bufferOffset);
    // Serialize message field [preshape2]
    bufferOffset = _serializer.float64(obj.preshape2, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ForceCommand(null);
    ...
    // Deserialize message field [preshape1]
    data.preshape1 = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [preshape2]
    data.preshape2 = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'reflex_one_msgs/ForceCommand';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ForceCommand(null);
    if (msg.f1 !== undefined) {
      resolved.f1 = msg.f1;
    }
    else {
    ...
    if (msg.preshape1 !== undefined) {
      resolved.preshape1 = msg.preshape1;
    }
    else {
      resolved.preshape1 = 0.0
    }

    if (msg.preshape2 !== undefined) {
      resolved.preshape2 = msg.preshape2;
    }
    else {
      resolved.preshape2 = 0.0
    }
