...
class SetSpeedRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.motor, buffer, bufferOffset, 4);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.motor = _arrayDeserializer.float64(buffer, bufferOffset, 4)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.motor !== undefined) {
      ...
      resolved.motor = new Array(4).fill(0)
    }
...
class SetSpeedResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'reflex_msgs2/SetSpeedResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '7e4d6fd69113a7a3ab5caa755082c6b7'; },
  datatype() { return 'reflex_msgs2/SetSpeed'; }
};
