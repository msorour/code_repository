...
class MotorState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int64(obj.goal, buffer, bufferOffset);
    // Serialize message field [position]
    bufferOffset = _serializer.int64(obj.position, buffer, bufferOffset);
    // Serialize message field [error]
    bufferOffset = _serializer.int64(obj.error, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.goal = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [position]
    data.position = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [error]
    data.error = _deserializer.int64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '2184111e0e6b6ad4961bf5f12a5055e3';
  }
  ...
  static messageDefinition() {
    ...
    int32 id            # motor id
    int64 goal          # commanded position (in encoder units)
    int64 position      # current position (in encoder units)
    int64 error         # difference between current and goal positions
    int64 speed         # current speed (0.111 rpm per unit)
