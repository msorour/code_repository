...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'reflex_visualizer2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/business/code_repository/ros_packages/src/reflex-ros-pkg/reflex_visualizer2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT reflex_visualizer2_NUM_DUMMY_TARGETS)
      set(reflex_visualizer2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::reflex_visualizer2::wrapped-linker-option${reflex_visualizer2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR reflex_visualizer2_NUM_DUMMY_TARGETS "${reflex_visualizer2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::reflex_visualizer2::wrapped-linker-option${reflex_visualizer2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND reflex_visualizer2_LIBRARIES "${interface_target_name}")
