...
Eigen::Vector4d thumb_joint_safe_max((Eigen::Vector4d() << thumb_joint_0_max-joint_safety_margin, thumb_joint_1_max-joint_safety_margin, thumb_joint_2_max-joint_safety_margin, thumb_joint_3_max-joint_safety_margin).finished());
Eigen::Vector4d thumb_joint_safe_min((Eigen::Vector4d() << thumb_joint_0_min+joint_safety_margin, thumb_joint_1_min+joint_safety_margin, thumb_joint_2_min+joint_safety_margin, thumb_joint_3_min+joint_safety_margin).finished());

Eigen::Vector4d index_joint_safe_max((Eigen::Vector4d() << index_joint_0_max-joint_safety_margin, index_joint_1_max-joint_safety_margin, index_joint_2_max-joint_safety_margin, index_joint_3_max-joint_safety_margin).finished());
Eigen::Vector4d index_joint_safe_min((Eigen::Vector4d() << index_joint_0_min+joint_safety_margin, index_joint_1_min+joint_safety_margin, index_joint_2_min+joint_safety_margin, index_joint_3_min+joint_safety_margin).finished());

Eigen::Vector4d middle_joint_safe_max((Eigen::Vector4d() << middle_joint_0_max-joint_safety_margin, middle_joint_1_max-joint_safety_margin, middle_joint_2_max-joint_safety_margin, middle_joint_3_max-joint_safety_margin).finished());
Eigen::Vector4d middle_joint_safe_min((Eigen::Vector4d() << middle_joint_0_min+joint_safety_margin, middle_joint_1_min+joint_safety_margin, middle_joint_2_min+joint_safety_margin, middle_joint_3_min+joint_safety_margin).finished());

Eigen::Vector4d pinky_joint_safe_max((Eigen::Vector4d() << pinky_joint_0_max-joint_safety_margin, pinky_joint_1_max-joint_safety_margin, pinky_joint_2_max-joint_safety_margin, pinky_joint_3_max-joint_safety_margin).finished());
Eigen::Vector4d pinky_joint_safe_min((Eigen::Vector4d() << pinky_joint_0_min+joint_safety_margin, pinky_joint_1_min+joint_safety_margin, pinky_joint_2_min+joint_safety_margin, pinky_joint_3_min+joint_safety_margin).finished());
...
Eigen::Vector3d position_Ptt, position_Ptt_past, position_Ptt_desired, position_Ptt_init, position_Ptt_traj, position_Ptt_error;
Eigen::Vector3d position_Pit, position_Pit_past, position_Pit_desired, position_Pit_init, position_Pit_traj, position_Pit_error;
Eigen::Vector3d position_Pmt, position_Pmt_past, position_Pmt_desired, position_Pmt_init, position_Pmt_traj, position_Pmt_error;
Eigen::Vector3d position_Ppt, position_Ppt_past, position_Ppt_desired, position_Ppt_init, position_Ppt_traj, position_Ppt_error;

Eigen::Vector3d velocity_Ptt_desired_3d, velocity_Pit_desired_3d, velocity_Pmt_desired_3d, velocity_Ppt_desired_3d;
Eigen::Vector3d velocity_Ptt_3d, velocity_Pit_3d, velocity_Pmt_3d, velocity_Ppt_3d;
Eigen::Vector3d velocity_Ptt_cmd_3d, velocity_Pit_cmd_3d, velocity_Pmt_cmd_3d, velocity_Ppt_cmd_3d;
...
int main(int argc, TCHAR* argv[]){
  ...
  if(CreateBHandAlgorithm() && OpenCAN()){
    ...
    double ros_time_now, ros_time_past, sample_time;
    int i = 0;
    ...
    position_Ptt_past = position_Ptt;
		position_Pit_past = position_Pit;
		position_Pmt_past = position_Pmt;
		position_Ppt_past = position_Ppt;
    while( ros::ok() ){
			i++;
      ros_time_now = ros::Time::now().toNSec();
      if(i==1)
				sample_time = 1.0/300.0;
			else
				sample_time = ros_time_now - ros_time_past;
      ...
      position_Ptt << pose_rpy_Ptt(0), pose_rpy_Ptt(1), pose_rpy_Ptt(2);
	    ...
	    velocity_Ptt_3d = (position_Ptt - position_Ptt_past)/sample_time;
	    velocity_Pit_3d = (position_Pit - position_Pit_past)/sample_time;
	    velocity_Pmt_3d = (position_Pmt - position_Pmt_past)/sample_time;
	    velocity_Ppt_3d = (position_Ppt - position_Ppt_past)/sample_time;
	    ...
	    */
	    velocity_Ptt_desired_3d << 0.001,0.001,0.001;
	    velocity_Pit_desired_3d << 0.001,0.001,0.001;
	    velocity_Pmt_desired_3d << 0.001,0.001,0.001;
	    velocity_Ppt_desired_3d << 0.001,0.001,0.001;
	    
	    velocity_Ptt_cmd_3d = 0.5*(velocity_Ptt_desired_3d - velocity_Ptt_3d) + 0.5*position_Ptt_error;
	    velocity_Pit_cmd_3d = 0.5*(velocity_Pit_desired_3d - velocity_Pit_3d) + 0.5*position_Pit_error;
	    velocity_Pmt_cmd_3d = 0.5*(velocity_Pmt_desired_3d - velocity_Pmt_3d) + 0.5*position_Pmt_error;
	    velocity_Ppt_cmd_3d = 0.5*(velocity_Ppt_desired_3d - velocity_Ppt_3d) + 0.5*position_Ppt_error;
	    ...
	    //thumb_joint_velocity_command  = Pinv_damped(thumb_position_jacobian, 0.001)*velocity_Ptt_cmd_3d + lambda*finger_null_space_projector*finger_task_gradient;
	    thumb_joint_velocity_command  = Pinv_damped(thumb_position_jacobian, 0.001)*velocity_Ptt_cmd_3d;
	    ...
	    //index_joint_velocity_command  = Pinv_damped(index_position_jacobian, 0.001)*velocity_Pit_cmd_3d + lambda*finger_null_space_projector*finger_task_gradient;
			index_joint_velocity_command  = Pinv_damped(index_position_jacobian, 0.001)*velocity_Pit_cmd_3d;
	    ...
	    //middle_joint_velocity_command  = Pinv_damped(middle_position_jacobian, 0.001)*velocity_Pmt_cmd_3d + lambda*finger_null_space_projector*finger_task_gradient;
			middle_joint_velocity_command  = Pinv_damped(middle_position_jacobian, 0.001)*velocity_Pmt_cmd_3d;
	    ...
	    //pinky_joint_velocity_command  = Pinv_damped(pinky_position_jacobian, 0.001)*velocity_Ppt_cmd_3d + lambda*finger_null_space_projector*finger_task_gradient;
      pinky_joint_velocity_command  = Pinv_damped(pinky_position_jacobian, 0.001)*velocity_Ppt_cmd_3d;
      ...
      /*
      char execute;
			std::cout << "Press [h] to go to home position or [g] to do simple soft grasp ... " << std::endl;
			std::cin.get(execute);
			if(execute == 'g'){
