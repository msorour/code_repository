...
#include "include/grasping_algorithm_paper.h"
#include <math.h>
#include "QuadProg++.hh"
...
int main (int argc, char** argv){
  ...
  */
  ...
  while ( !scene_cloud_viewer->wasStopped() ){
    scene_cloud_viewer->spinOnce();
		//save_file_name = "best_pose.png";
		//save_file_name = "metric1_franka_distance_between_gripper_workspace_and_object_centroids.png";
		//save_file_name = "metric2_franka_object_centroid_encapsulation.png";
		//save_file_name = "metric3_franka_number_of_object_points_in_gripper_spheres.png";
		save_file_name = "metric4_franka_gripper_support_region.png";
