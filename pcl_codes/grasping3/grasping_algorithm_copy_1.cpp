...
int main (int argc, char** argv){
  ...
  *scene_cloud_xyzrgb += *gripper_cloud_in_arm_link8_frame_xyzrgb;
  ...
  pcl::PointCloud<pcl::PointXYZRGB> object_plane_special_ellipsoid_point_cloud_in_gripper_frame;
  ...
  //pcl::transformPointCloud(object_plane_special_ellipsoid_point_cloud_in_object_plane_frame, object_plane_special_ellipsoid_point_cloud_in_gripper_frame, camera_optical_frame_wrt_gripper_frame_transform);
  //*object_plane_transformed_cloud_xyzrgb += object_plane_special_ellipsoid_point_cloud_in_gripper_frame;
  ...
  *scene_cloud_xyzrgb += *object_plane_cloud_in_object_plane_frame_xyzrgb;
  ...
  pcl::transformPointCloud(*object_points_in_thumb_workspace_best, *object_points_in_thumb_workspace_best, best_gripper_transform);
  ...
  pcl::transformPointCloud(*object_points_in_index_workspace_best, *object_points_in_index_workspace_best, best_gripper_transform);
  ...
  pcl::transformPointCloud(*object_points_in_middle_workspace_best, *object_points_in_middle_workspace_best, best_gripper_transform);
  ...
  pcl::transformPointCloud(*object_points_in_pinky_workspace_best, *object_points_in_pinky_workspace_best, best_gripper_transform);
  ...
  // draw the workspace spheres of the best gripper pose
  // right_finger
  scene_cloud_viewer->addPointCloud(right_finger_workspace_spheres_best, red_color_again, "right finger workspace spheres");
  scene_cloud_viewer->addPointCloud(object_points_in_right_finger_workspace_best, red_color_again, "right finger workspace points");
  ...
  scene_cloud_viewer->updatePointCloud(right_finger_workspace_spheres_best, red_color_again, "right finger workspace spheres");
  
  pcl::transformPointCloud(*object_points_in_right_finger_workspace_best, *object_points_in_right_finger_workspace_best, best_gripper_transform);
  scene_cloud_viewer->updatePointCloud(object_points_in_right_finger_workspace_best, red_color_again, "right finger workspace points");
  scene_cloud_viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 15, "right finger workspace points");
  
  // left_finger
  scene_cloud_viewer->addPointCloud(left_finger_workspace_spheres_best, green_color_again, "left finger workspace spheres");
  scene_cloud_viewer->addPointCloud(object_points_in_left_finger_workspace_best, red_color_again, "left finger workspace points");
  ...
  scene_cloud_viewer->updatePointCloud(left_finger_workspace_spheres_best, green_color_again, "left finger workspace spheres");
  
  pcl::transformPointCloud(*object_points_in_left_finger_workspace_best, *object_points_in_left_finger_workspace_best, best_gripper_transform);
  scene_cloud_viewer->updatePointCloud(object_points_in_left_finger_workspace_best, green_color_again, "left finger workspace points");
  scene_cloud_viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 15, "left finger workspace points");
  }
  ...
  // to show gripper cloud in gripper frame
  *gripper_cloud_transformed_in_gripper_frame_xyzrgb += *gripper_cloud_in_gripper_frame_xyzrgb;
  
  scene_cloud_viewer->updatePointCloud(gripper_cloud_transformed_in_gripper_frame_xyzrgb, black_color, "gripper cloud");
  scene_cloud_viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 5, "gripper cloud");
  ...
  // to show object cloud in gripper frame
  gripper_rotation << best_gripper_transform(0,0), best_gripper_transform(0,1), best_gripper_transform(0,2),
  ...
  gripper_translation << best_gripper_transform(0,3), best_gripper_transform(1,3), best_gripper_transform(2,3);
  inverse_gripper_transform << gripper_rotation.transpose(), -gripper_rotation.transpose()*gripper_translation,  // from khalil's book page 21
                               0, 0, 0, 1;
  pcl::transformPointCloud(*object_cloud_downsampled_in_gripper_frame_xyzrgb, *object_cloud_transformed_in_gripper_frame_xyzrgb, inverse_gripper_transform);
  *object_cloud_downsampled_in_gripper_frame_xyzrgb += *object_cloud_transformed_in_gripper_frame_xyzrgb;
  //scene_cloud_viewer->updatePointCloud(object_cloud_in_gripper_frame_xyzrgb, magenta_color, "object cloud in object frame");
  
  /*
  pcl::transformPointCloud(*object_points_in_thumb_workspace_best, *object_points_in_thumb_workspace_best, inverse_gripper_transform);
  scene_cloud_viewer->updatePointCloud(object_points_in_thumb_workspace_best, red_color, "object cloud");
  scene_cloud_viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 15, "object cloud");
  */
