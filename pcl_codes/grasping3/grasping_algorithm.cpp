...
reset && cmake .. && make && ./grasping_algorithm ../gripper_pcd_model/allegro_right_hand_model_cloud_plus_camera.pcd 0.01 ../object_pcd_files/mug.pcd 0.005 ../object_pcd_files/mug_table.pcd
*/
...
int main (int argc, char** argv){
  ...
  for(int i=0; i<thumb_workspace_convex_parameter->size(); i++)
    std::cout << "thumb_workspace_convex_parameter = " << thumb_workspace_convex_parameter->points[i].x << std::endl;
